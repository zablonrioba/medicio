...
<head>
    ...
    <title>Medicio APPOINTMENT</title>
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									...
									<form name="myForm" onSubmit="return validateForm()"action="appoint.php" method="post">
										...
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Date</label>
													<input type="date" name="date" id="date" class="form-control input-md" min=<?php
         echo date('Y-m-d');
     ?>>
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Time</label>
													<input type="time" name="time" id="time" class="form-control input-md" min="9:00" max="18:00" >
												</div>
											</div>
										</div>
										...
										<p class="lead-footer">* We'll contact you by phone & email</p>
