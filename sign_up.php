...
<head>
    ...
    <title>Medicio sign up page</title>
		...
		<div class="intro-content">
			<div class="container">
				<div class="row">
					...
					<h4 class="h-light"> <span class="color">Best quality healthcare</span> </h4>
					</div>
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span>CREATE AN ACCOUNT </h3>
									</div>
									...
									<form name="myForm" onSubmit="return validateForm()"action="registration.php" method="post">
										...
										<div class="row">
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="password" name="cpassword" id="cpassword" class="form-control input-md">
												</div>
											</div>
										</div>
										...
										<a href="sign_in.php"><p class="lead-footer">Already a member? Log in<p></a>
